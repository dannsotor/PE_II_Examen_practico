[5:11 PM, 9/17/2025] Camila UPT 5 TO CICLO: <?php
// Iniciar sesión
session_start();
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-i…
[5:29 PM, 9/17/2025] Camila UPT 5 TO CICLO: <?php
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guardar'])) {
  ...
  if ($planData->actualizarMision($idPlan, $nuevaMision)) {
